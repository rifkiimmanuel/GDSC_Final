...
if(isset($_GET['id'])){
    ...
    // ambil data dari database menggunakan join
    $result = mysqli_query($conn, "SELECT od.*, f.food_name FROM order_detail od JOIN food f ON od.food_id = f.food_id WHERE order_id = '{$order_id}'");
    $row = mysqli_fetch_assoc($result);

    // display reservation details if row is not null
    if ($row) {
        echo "Order ID: " . $row['order_id'] . "<br>";
        echo "Food Name: " . $row['food_name'] . "<br>";
        echo "Total Order: " . $row['total_order'] . "<br>";
        echo "Order Unit Price: " . $row['order_unit_price'] . "<br>";
    } else {
...
<section id="book-a-table" class="book-a-table">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row g-0">
            ...
            <table>
            <div class="judul">
        <a> Your Reservation Succesfully!</a>
        </div>
            <tr>
                <td>Order ID</td>
        ...
        <div class="buttons">
        <a href="reservation_detail2.php" class="btn btn-secondary">Check Your Reservation</a>
