      ...
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown">
              <a href="#"
                ><span>Step For Reservation</span>
                <i class="bi bi-chevron-down dropdown-indicator"></i
              ></a>
              <ul>
                <li><a href="addcust.php">Add your data</a></li>
                <li class="dropdown">
                <li><a href="addreservation.php">Add reservation</a></li>
                <li><a href="addfood.php">Order your food</a></li>
                <li><a href="addordertable.php">Add your order</a></li>
              </ul>
          </ul>
        </nav>
        <!-- .navbar -->

        <a class="btn-book-a-table" href="register.php">Register Here !!!</a>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Table Rest <b>Details</b></h2></div>
                    <div class="col-sm-4">
