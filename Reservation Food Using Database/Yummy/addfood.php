    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
                <form action="addfood.php" method="post" role="form" class="php-email-form aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    <div class="row gy-4">
                        <div class="col-lg-4 col-md-6">
                            <input type="text" name="food_id" class="form-control" id="id" placeholder="Food ID" data-rule="minlen:4" data-msg="Please enter at least 10 characters">
                            <div class="validate"></div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <input type="text" class="form-control" name="food_name" id="" placeholder="Food Name" data-rule="name" data-msg="Please enter a valid food name">
                            <div class="validate"></div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <input type="text" class="form-control" name="food_description" id="description" placeholder="Food Description" data-rule="minlen:4" data-msg="Please enter a description">
                            <div class="validate"></div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <input type="text" name="food_price" class="form-control" id="price" placeholder="Food Price" data-rule="minlen:4" data-msg="Please enter food price">
                            <div class="validate"></div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <input type="text" name="category_id" class="form-control" id="category" placeholder="Category ID" data-rule="minlen:4" data-msg="Please enter food category id">
                            <div class="validate"></div>
                        </div>
                    </div>
                   ...
                   <td style="text-align: center;">
                      <input type="submit" name="Submit" value="Next" href="indexfood.php" style="background-color: red; color: white; border-radius: 50px; padding: 10px 20px; transition: background-color 0.5s;">
                   </td>
