...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            <a href="indexowner.php" class="logo d-flex align-items-center me-auto me-lg-0">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="indexreservation.php">List Reservation</a></li>
...
<form action="" method="get">
    <input type="text" name="cari" placeholder="search data...">
    <button type="submit" style="background-color: red; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease-in-out;">Search</button>
</form>
