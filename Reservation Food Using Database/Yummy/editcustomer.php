...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
        <form action="editcustomer.php" method="post" role="form" class="php-email-form aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                <div class="col-lg-12">
                    <label for="name">Name</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?php echo $name;?>" style="text-align: center; border-bottom: 1px solid #ccc;">
                </div>
                <div class="col-lg-12">
                    <label for="phone_number">Phone number</label>
                    <input type="text" class="form-control" name="phone_number" id="phone_number" placeholder="Phone Number" value="<?php echo  $phone_number;?>" style="text-align: center; border-bottom: 1px solid #ccc;">
                </div>
                <div class="col-lg-12">
                    <label for="email">Email</label>
                    <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="<?php echo $email;?>" style="text-align: center; border-bottom: 1px solid #ccc;">
                </div>
                <div class="col-lg-12">
                    <label for="address">Address</label>
                    <input type="text" class="form-control" name="address" id="address" placeholder="address" value="<?php echo $address;?>" style="text-align: center; border-bottom: 1px solid #ccc;">
                </div>
            </div>
